...
const Blog = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center py-8 px-4">
      ...
      {/* Main Heading */}
      <h1 className=" text-lg sm:text-3xl font-bold text-gray-800 mb-6 text-center">Crypto Tracking & Recovery Blog</h1>
          ...
          <ul className="space-y-6">
            {posts.map((post, index) => (
              <li key={index} className="border-b pb-4">
                <a href={post.link} className="text-lg text-blue-600 hover:underline">{post.title}</a>
